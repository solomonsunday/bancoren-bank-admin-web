...
$('#login-form').submit(function (e) {
  e.preventDefault();
  var formData = getFormAsJsonData('#login-form');
  ...
  $.ajax({
    ...
    success: function success(data, status, xhr) {
      ...
      redirectTo(url); //console.log(data)
    },
...
module.exports = __webpack_require__(/*! /Users/itexecutive/Documents/bancoren-v2-admin/resources/js/pages/login.js */"./resources/js/pages/login.js");
